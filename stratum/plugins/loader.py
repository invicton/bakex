...
from stratum.plugins.subprocess_provider import SUBPROCESS_SENTINEL, make_subprocess_provider_class
...
def load_providers(
    ...
    1. pip entry_points in group ``stratum.providers``
    ...
    try:
        eps = importlib.metadata.entry_points(group="stratum.providers")
        for ep in eps:
            try:
                cls = ep.load()
