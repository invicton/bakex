...
"""Anthropic API backend for the Stratum agentic build system.

Env vars:
  ANTHROPIC_API_KEY     — required
  STRATUM_LLM_MODEL     — model ID override (default: claude-opus-4-6)
  STRATUM_LLM_THINKING  — set to "0" to disable extended thinking (default: enabled)
"""
...
class AnthropicBackend:
    ...
    def __init__(self, model: str | None = None) -> None:
        self.model = model or os.environ.get("STRATUM_LLM_MODEL", "claude-opus-4-6")
        self.use_thinking = os.environ.get("STRATUM_LLM_THINKING", "1") not in ("0", "false", "no")
