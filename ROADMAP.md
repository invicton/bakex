...
Stratum's goal: **the layer that makes Ansible-Lockdown + OpenSCAP + every major
...
- [ ] CIS Level 2 coverage for every OS that supports it
      ([#1](https://github.com/StratumOSS/Stratum/issues/1),
      [#2](https://github.com/StratumOSS/Stratum/issues/2),
      [#3](https://github.com/StratumOSS/Stratum/issues/3))
- [ ] Ubuntu 24.04 blueprints ([#4](https://github.com/StratumOSS/Stratum/issues/4))
- [ ] First STIG blueprints ([#7](https://github.com/StratumOSS/Stratum/issues/7))
...
CI. Stratum should be the OS-hardening tool an agent can operate correctly:
...
- [ ] Interop guides: Stratum with Packer, Stratum + Ansible-Lockdown,
...
Open a [Discussion](https://github.com/StratumOSS/Stratum/discussions) or an
