...
from stratum.core.llm.bedrock_backend import _messages_to_bedrock, _tools_to_bedrock
from stratum.core.llm.factory import get_backend, provider_status
from stratum.core.llm.openai_backend import _messages_to_openai_clean, _tools_to_openai
...
class TestFactory:
    def test_default_provider_is_anthropic(self, monkeypatch):
        monkeypatch.delenv("STRATUM_LLM_PROVIDER", raising=False)
    ...
    def test_unknown_provider_raises(self, monkeypatch):
        monkeypatch.setenv("STRATUM_LLM_PROVIDER", "grok")
    ...
    def test_model_override(self, monkeypatch):
        ...
        monkeypatch.setenv("STRATUM_LLM_MODEL", "claude-haiku-4-5-20251001")
        backend = get_backend()
...
class TestProviderStatus:
    ...
    def test_status_includes_model(self, monkeypatch):
        monkeypatch.setenv("STRATUM_LLM_PROVIDER", "anthropic")
        monkeypatch.setenv("STRATUM_LLM_MODEL", "claude-sonnet-4-6")
        monkeypatch.setenv("ANTHROPIC_API_KEY", "sk-test")
        status = provider_status()
