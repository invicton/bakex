...
class TestBuildParams:
    ...
    def test_params_prehard_playbook_included_when_generated(self, tmp_path):
        ...
        with patch("bakex.core.playbook_gen.generate_prehard_playbook", return_value=fake_path):
            params = _build_params(profile)
    ...
    def test_params_prehard_exception_skipped(self):
        ...
        profile = _make_profile()
        with patch("bakex.core.playbook_gen.generate_prehard_playbook", side_effect=RuntimeError("boom")):
            params = _build_params(profile)
...
class TestSubprocessProviderMethods:
    def test_audit_calls_execute_audit_rpc(self):
        ...
        with patch("bakex.plugins.subprocess_provider._call_rpc", return_value={"raw_xml": "<xccdf/>"}) as mock_rpc:
            with patch("bakex.api.integrations.get_credentials", return_value={}):
    ...
    def test_audit_passes_target_id_in_params(self):
        ...
        with patch("bakex.plugins.subprocess_provider._call_rpc", return_value={}) as mock_rpc:
            with patch("bakex.api.integrations.get_credentials", return_value={}):
    ...
    def test_scan_image_merges_credentials(self):
        ...
        with patch("bakex.plugins.subprocess_provider._call_rpc", return_value={}) as mock_rpc:
            with patch("bakex.api.integrations.get_credentials", return_value=creds):
