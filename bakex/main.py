...
from bakex.api import agent as agent_api
from bakex.api import api_keys as api_keys_api
from bakex.api import auditor, blueprints, builder, integrations, plugins, ui
from bakex.api import pipeline as pipeline_api
from bakex.api import registry as registry_api
from bakex.api import system as system_api
from bakex.api import webhooks as webhooks_api
from bakex.api.integrations import credential_store
from bakex.config import settings
from bakex.core.auth import require_admin, require_admin_or_key
from bakex.core.registry import RegistrySource, init_registry
from bakex.core.sysdeps import check_system_deps
from bakex.paths import STATIC_DIR
...
async def lifespan(app: FastAPI):
    from bakex.core.auth import get_admin_token
    ...
    from bakex.core.auditor import load_jobs as _load_audit_jobs

    _load_audit_jobs()
    logger.info("Audit job store ready")

    from bakex.core.api_keys import load_keys as _load_api_keys

    _load_api_keys()
    logger.info("API key store ready")

    from bakex.core.notifications import load_webhooks as _load_webhooks
