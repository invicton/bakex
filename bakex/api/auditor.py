...
from bakex.core import auditor as audit_service
...
async def compare_scans(job_id: str, baseline_id: str) -> dict:
    ...
    from bakex.openscap.parser import compute_delta
        ...
        "runs": [
            {
                "tool": {
                    "driver": {
                        "name": "BakeX Compliance Scanner",
                        "version": "0.1.1",
                        "informationUri": "https://github.com/invicton/bakex",
                        "rules": rules,
                    }
                },
                "results": results,
