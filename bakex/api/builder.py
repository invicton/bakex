...
async def start_build(request: Request, background_tasks: BackgroundTasks):
    ...
    from bakex.core.blueprint import ExtraVolume, MountEntry
    ...
    from bakex.api.integrations import get_credentials as _get_creds
...
async def get_instance_types(provider: str = "") -> dict:
    ...
    from bakex.core.os_catalog import INSTANCE_TYPES
...
async def resolve_image(os: str = "", provider: str = "aws", region: str = "us-east-1") -> dict:
    ...
    """
    from bakex.core.os_catalog import OS_CATALOG
...
async def get_cis_layout(os: str = "") -> HTMLResponse:
    ...
    from bakex.core.os_catalog import CIS_STANDARD_LAYOUT
...
async def get_controls(
    ...
    from bakex.core.os_catalog import CIS_CONTROLS
