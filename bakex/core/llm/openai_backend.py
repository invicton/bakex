...
"""OpenAI-compatible API backend for the BakeX agentic build system.

Works with any OpenAI-compatible endpoint:
  • OpenAI (api.openai.com)
  • Groq, Together AI, Fireworks
  • vLLM / LiteLLM self-hosted
  • Ollama  — set BAKEX_LLM_PROVIDER=ollama or pass base_url manually

Env vars:
  BAKEX_LLM_MODEL     — model name (default: gpt-4o for openai, llama3.3:70b for ollama)
  BAKEX_LLM_API_KEY   — API key (falls back to OPENAI_API_KEY; for Ollama use "ollama")
  BAKEX_LLM_BASE_URL  — base URL override (e.g. http://localhost:11434/v1 for Ollama)
"""
...
class OpenAICompatBackend:
    ...
    def __init__(
        ...
        self.model = model or os.environ.get("BAKEX_LLM_MODEL", "gpt-4o")
        self.base_url = base_url or os.environ.get("BAKEX_LLM_BASE_URL")
        self.api_key = api_key or os.environ.get("BAKEX_LLM_API_KEY") or os.environ.get("OPENAI_API_KEY", "")
