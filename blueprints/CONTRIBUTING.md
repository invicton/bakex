...
Not every OS Stratum could theoretically support is actually ready for a blueprint yet. A
...
either a ComplianceAsCode/content profile PR or a new `ansible-lockdown` role — not a Stratum
...
target:
  # os: Stratum OS identifier. Must match a key in stratum/core/os_catalog.py's OS_CATALOG.
  os: rocky9
  arch: x86_64
