...
async def start_build(request: Request, background_tasks: BackgroundTasks):
    ...
    from statim.core.blueprint import ExtraVolume, MountEntry
    ...
    from statim.api.integrations import get_credentials as _get_creds
...
async def os_catalog_endpoint() -> dict:
    ...
    from statim.core.os_catalog import OS_CATALOG, PROVIDER_CATALOG
...
async def get_instance_types(provider: str = "") -> dict:
    ...
    from statim.core.os_catalog import INSTANCE_TYPES
...
async def resolve_image(os: str = "", provider: str = "aws", region: str = "us-east-1") -> dict:
    ...
    """
    from statim.core.os_catalog import OS_CATALOG
...
async def get_cis_layout(os: str = "") -> HTMLResponse:
    ...
    from statim.core.os_catalog import CIS_STANDARD_LAYOUT
...
async def get_controls(
    ...
    from statim.core.os_catalog import CIS_CONTROLS
