...
from statim.plugins.base_provider import BaseProvider
from statim.plugins.subprocess_provider import SUBPROCESS_SENTINEL, make_subprocess_provider_class
...
def load_providers(
    ...
    1. pip entry_points in group ``statim.providers``
    ...
    try:
        eps = importlib.metadata.entry_points(group="statim.providers")
        for ep in eps:
            try:
                cls = ep.load()
