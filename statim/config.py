...
class Settings(BaseSettings):
    ...
    statim_secret_key: str | None = None
    statim_admin_token: str | None = None
    statim_agent_require_confirmation: bool = True
    debug: bool = False
    strict_plugins: bool = True
    registry_url: str = "https://raw.githubusercontent.com/statim/Statim/main/blueprints"
